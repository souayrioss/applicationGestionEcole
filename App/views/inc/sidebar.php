       ...
       <div>
          <div class=" mx-auto  lg:px-6 ">
             <ul class=" l text-center justify-center md:justify-start ">
                <li class=" flex-1">
                    <a href="#" class="block py-1 text-grey-darkest no-underline "> 
                   <img src="<?php echo URLROOT ;?>/img/Arrow.svg" alt="arrow" class="float-right">
                    </a>
                <li class=" flex-1 ">
                ...
                <li class="  flex-1  mb-20">
                    <a href="#" class="block  text-white no-underline ">
                     <span class=" lg:text-4xl md:text-2xl hidden md:block ">Welcom M,"username"</span>
                    </a>
                 </li>
